    ...
    id='contact'className='w-full px-[12%] py-10 scroll-mt-20
     bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
         I'd love too hear from you! If you have any questions, comments, or feedback,
      ...
      onSubmit={onSubmit} className='max-w-2xl mx-auto'>
         <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
           ...
           type="text"  placeholder='Enter yor name' required 
           ...
           type="email"  placeholder='Enter yor email' required 
           className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 
