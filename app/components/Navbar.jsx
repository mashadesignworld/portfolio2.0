...
<a href="#top">
  <Image 
    ...
    className="max-w-[13rem] h-auto cursor-pointer mr-14" 
    alt="logo" 
  ...
  />
        ...
        <div className='flex items-center gap-4'>
            ...
            py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo'>Contact
             <Image src={isDarkMode ? assets.arrow_icon_dark : assets.arrow_icon} className='w-3'  alt='icon'/></a>
             <button  className='block md:hidden ml-3' onClick={openMenu}>
              <Image src={isDarkMode ? assets.menu_white : assets.menu_black} alt='' className='w-6'/>
            </button>
        </div>
        {/*-------Mobile Menu -------- */}
          <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4
          py-20 px-10 fixed -right-64 top-0 bottom-0 w-44 z-50 h-screen bg-amber-600 text-white transition duration-500'>
